...
def init_arg() -> Any:
    ...
    parser.add_argument("--experiment", default="acic", type=str)
    parser.add_argument("--file_name", default="results", type=str)
    parser.add_argument("--n_exp", default=10, type=int)  # number of seeds
    parser.add_argument(
        "--n_reps", default=1, type=int
    )  # number of times to repeat for each seed
    parser.add_argument("--pre_trans", type=bool, default=False)
    parser.add_argument("--simu_num", type=int, default=2)  # relevant for acic
